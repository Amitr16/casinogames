              ...
              {[0,32,15,19,4,21,2,25,17,34,6,27,13,36,11,30,8,23,10,5,24,16,33,1,20,14,31,9,22,18,29,7,28,12,35,3,26].map((num, i) => {
                ...
                return (
                  <div key={num} style={{
                    ...
                    left: '50%',
                    transformOrigin: '0 0',
                    transform: `translate(-50%, -50%) rotate(${angle}deg) translate(0, -340.5px)`
                  }}>
                    ...
                    <div style={{
                      ...
                      borderBottom: `340.5px solid ${segmentColor}`,
                      opacity: 0.9
                    }} />
              ...
              {Array.from({length: 37}).map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    transformOrigin: '1.5px 180.25px',
                    transform: `translate(-50%, -50%) rotate(${i * (360/37)}deg) translate(-1.5px, -180.25px)`,
                    zIndex: 5
                  }}
                />
              ))}
